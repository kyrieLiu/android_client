...
public class LeaderPushWorkScheduleListActivity extends BaseActivity implements XListView.IXListViewListener{
    ...
    private List<LeaderDailyBean.ResultBean.ListBean> list=new ArrayList<>();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case ConstantCode.POST_FAILED:
                    Toast.makeText(LeaderPushWorkScheduleListActivity.this,"加载失败,请检查网络!",Toast.LENGTH_SHORT).show();
                    break;
    ...
    private void listenListView(){
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(LeaderPushWorkScheduleListActivity.this,WorkArrangeDetailsActivity.class);
