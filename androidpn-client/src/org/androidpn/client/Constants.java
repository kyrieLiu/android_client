...
public class Constants {
	...
	public static final String NOTIFICATION_IMAGE_URL = "NOTIFICATION_IAMGE_URL";

	public static final String MESSAGE_SEND_TIME="MESSAGE_SEND_TIME";

	public static final String MESSAGE_SEND_USER="MESSAGE_SEND_USER";

	public static final String MESSAGE_PEOPLE_NAME="MESSAGE_PEOPLE_NAME";
	...
	public static final String ACTION_MESSAGE_RECEIVED="org.androidpn.client.MESSAGE_RECEIVED";
