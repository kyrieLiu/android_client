...
public class XmppManager {
	...
	public XmppManager(NotificationService notificationService, String name, boolean isChangeName) {
	...
	private boolean isRegistered() {
			...
			boolean flag=sharedPrefs.contains(Constants.XMPP_USERNAME)
	...
	private class RegisterTask implements Runnable {
		...
		public void run() {
			if (!xmppManager.isRegistered()) {
				...
				registration.addAttribute("username", name);
	...
	private class LoginTask implements Runnable {
		...
		public void run() {
			...
			if (!isAuthenticated()) {
				Log.i("info","isAuthenticated");
				try {
					xmppManager.getConnection().login(
							xmppManager.getUsername(),
							xmppManager.getPassword(), XMPP_RESOURCE_NAME);
					Log.i("info","username"+getUsername());
					Log.i("info","password"+getPassword());
	...
	private Handler mHandler=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			Toast.makeText(context,"推送服务连接成功",Toast.LENGTH_SHORT).show();
		}
	};
